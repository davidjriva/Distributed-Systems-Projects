...
public class ConnectWithNeighborEvent implements Event{
    String ipAddress;
    int portNum;

    public ConnectWithNeighborEvent(String ipAddress, int portNum) {
        this.ipAddress = ipAddress;
        this.portNum = portNum;
    }

    public ConnectWithNeighborEvent(byte[] marshalledBytes) throws IOException{
    ...
    public int getMessageType() {
        return EventType.CONNECT_WITH_NEIGHBOR;
    }
