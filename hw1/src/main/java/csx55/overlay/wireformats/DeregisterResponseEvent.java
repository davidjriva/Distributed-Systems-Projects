...
public class DeregisterResponseEvent implements Event {
    byte statusCode;
    String additionalInfo;

    public DeregisterResponseEvent(byte statusCode, String additionalInfo) {
        this.statusCode = statusCode;
        this.additionalInfo = additionalInfo;
    }

    public DeregisterResponseEvent(byte[] marshalledBytes) throws IOException {
